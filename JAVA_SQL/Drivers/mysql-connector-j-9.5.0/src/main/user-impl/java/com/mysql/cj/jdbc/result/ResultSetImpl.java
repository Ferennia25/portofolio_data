...
public class ResultSetImpl extends NativeResultset implements ResultSetInternalMethods, WarningListener {
    ...
    public Object getObject(int columnIndex) throws SQLException {
        ...
        switch (field.getMysqlType()) {
            ...
            case MysqlType.MEDIUMINT_UNSIGNED:
            case MysqlType.INT:
            ...
            case MysqlType.DECIMAL_UNSIGNED:
                String stringVal = getString(columnIndex);
            ...
            case MysqlType.FLOAT_UNSIGNED:
                return new Float(getFloat(columnIndex));

            case MysqlType.DOUBLE:
            case MysqlType.DOUBLE_UNSIGNED:
